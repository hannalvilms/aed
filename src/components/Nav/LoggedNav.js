                ...
                <div className="container">
                    <nav className="row navbar navbar-expand-lg navbar-light">
                        <div className="navbar-header header-logo">
                            <Link to="/avaleht-logitud" ><img src={logo} alt="logo"/></Link>
                        </div>
                        ...
                        <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
                            ...
                            <div className="nav navbar-right">
                                <Link to="/avaleht-logitud" className="nav-link btn btn-primary btn-xs">Materjalid</Link>
                                <Link to="/tulemused" className="nav-link btn btn-primary btn-xs">Konto</Link>
                                <Link to="/avaleht" onClick={this.logoutUser} className="nav-link btn btn-primary btn-xs">Logi välja</Link>
                            </div>
                        </div>
                    </nav>
                </div>
